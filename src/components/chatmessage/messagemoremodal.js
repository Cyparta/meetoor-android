...
import { CopySvg, DeleteSvg, ReplySvg } from '../../icons/all';
...
////////////////////////////////////////////
const MessageMoreModal = ({ msgid, isMe, text, file, date, isLast, justSeen }) => {
    console.log("MessageMoreModal ~ text", text)
    ...
    const onDelete = useCallback(() => {
        mainSocket.emit("onDeleteMessage", { msgid, isLast });
        modalizeWithNav.close();
    }, [modalizeWithNav, isLast, msgid]);
    ////////////////////////////////////////
